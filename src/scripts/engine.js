document.addEventListener('DOMContentLoaded', () => {
    ...
    const cards = [
        {
            name: 'monica',
            img: 'src/images/friends-monica.png'
        },

        {
            name: 'phoebe',
            img: 'src/images/friends-phoebe.png'
        },

        {
            name: 'rachel',
            img: 'src/images/friends-rachel.png'
        },

        {
            name: 'joey',
            img: 'src/images/friends-joey.png'
        },

        {
            name: 'chandler',
            img: 'src/images/friends-chandler.png'
        },

        {
            name: 'ross',
            img: 'src/images/friends-ross.png'
        },
    ...
    function createBoard() {
        for (let i = 0; i < cards.length; i++) {
            ...
            card.setAttribute('src', 'src/images/board.png')
    ...
    function checkForMatch() {
        ...
        if (optionOneId == optionTwoId) {
            cards[optionOneId].setAttribute('src', 'src/images/board.png')
            cards[optionTwoId].setAttribute('src', 'src/images/board.png')
            alert('Você clicou na mesma imagem')
        }
        //verificar combinação se click em imagens diferentes
        else if (cardsChosen[0] === cardsChosen[1]) {
            alert('Você encontrou uma combinação')
            cards[optionOneId].setAttribute('src', 'src/images/check.png')
            cards[optionTwoId].setAttribute('src', 'src/images/check.png')
